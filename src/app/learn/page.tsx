...
import { Lightbulb, Compass, Code2, ArrowRight, HelpCircle, MessageCircle } from "lucide-react";
      ...
      <section className="border-y border-line bg-surface py-16 sm:py-20">
        <div className="container-px mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="내 상황에 맞는 길 안내"
            description="지금您的 상황을 골라보세요. 가장合适的한 다음 단계를 안내해 드립니다."
          />
      ...
      <section className="bg-primary py-16 text-center text-white sm:py-20">
        <div className="container-px mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-primary-light">
            무슨 말인지 하나도 모르겠어도 괜찮습니다. JSTech가您的 situation에 맞는 방향을 함께 찾아드립니다.
          </p>
